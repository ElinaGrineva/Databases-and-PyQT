...
sys.path.append('../')
from lesson_5.message_proj.client.main_window_conv import Ui_MainClientWindow
from lesson_5.message_proj.client.add_contact import AddContactDialog
from lesson_5.message_proj.client.del_contact import DelContactDialog
from lesson_5.message_proj.client.client_database import ClientDatabase
from lesson_5.message_proj.client.transport import ClientTransport
from lesson_5.message_proj.client.start_dialog import UserNameDialog
from lesson_5.message_proj.common.errors_user import ServerError
