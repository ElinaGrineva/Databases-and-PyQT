...
import Lesson7.logs.client_logs_config
import socket
import logging
import sys
sys.path.append('../')
...
def login_required(func):
    ...
    def checker(*args, **kwargs):
        ...
        from lesson_7.message_proj.server.core import MessageProcessor
        from lesson_7.message_proj.common.variables import ACTION, PRESENCE
